          ...
          <div>
            ...
            <div className="mt-6">
              ...
              <div className="flex space-x-4">
                {/* Facebook */}
                <a href="https://web.facebook.com/profile.php?viewas=100000686899395&id=61560226833655" target="_blank" rel="noopener noreferrer" className="text-[#545454] hover:text-blue-600 transition-colors">
                ...
                {/* LinkedIn */}
                <a href="https://www.linkedin.com/company/poultry-professionals-society-pps/" target="_blank" rel="noopener noreferrer" className="text-[#545454] hover:text-blue-700 transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                ...
                {/* YouTube */}
                <a href="https://www.youtube.com/@ppsest2024" target="_blank" rel="noopener noreferrer" className="text-[#545454] hover:text-red-600 transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
